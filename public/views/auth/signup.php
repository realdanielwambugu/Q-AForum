    ...
    <main style='background-image:url("<?= basePath() ?>/public/assets/images/bg/bg.jpg")'
        ...
        <form id="signup_form" action="signup" method="post"
          class="w-11/12 lg:w-5/12 m-0-auto bgColor-2-400 py-10">
            ...
            <div class="fw-600 w-8/12 m-0-auto mb-2">
                <label for="email" class="color-1 block py-2 fs-sm">Email</label>
                <input class="w-full py-2 px-2 rounded b-color-sec-300 border-2
                focus:b-color-pri outline-0"
            ...
            <div class="fw-600 w-8/12 m-0-auto mb-2">
                <label for="password" class="color-1 block py-2 fs-sm">Password</label>
                <input class="w-full py-2 px-2 rounded b-color-sec-300 border-2
                focus:b-color-pri outline-0"
            ...
            <div class="fw-600 w-8/12 m-0-auto mb-2">
                <label for="confirmPassword" class="color-1 block py-2 fs-sm">
                    Confirm Password
                </label>
                <input class="w-full py-2 px-2 rounded b-color-sec-300 border-2
                focus:b-color-pri outline-0"
