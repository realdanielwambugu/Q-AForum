                    ...
                    <table class="table-auto border-collapse bgColor-trans m-0-auto">
                        ...
                        <tbody class="txt-h-c">
                            ...
                            <tr class="bgColor-1 border-0 shadow">
                                <td class="px-4 py-2 color-2-600 border-0"> <?= $user->id ?> </td>
                                <td class="px-4 py-2 color-2-600 border-0"> <?= $user->fullName ?> </td>
                                <td class="px-4 py-2 color-2-600 border-0"> <?= $user->email ?> </td>
                                <td class="px-4 py-2 color-2-600 border-0"> <?= $user->type ?> </td>
                                <td class="px-4 py-2 color-2-600 border-0"> <?= $user->status ?> </td>
                                <td class="px-4 py-2 color-2-600 border-0"> <?= $user->updated_at ?> </td>
                                <td class="px-4 py-2 color-2-600 border-0"> <?= $user->created_at ?> </td>
                            </tr>
